...
import { Icons } from "./window-control-icons";
...
export function MacOSWindowControls({
  ...
  return (
    ...
    >
      <button
        className={cn(
          "group flex h-3 w-3 cursor-default items-center justify-center rounded-full border text-center text-black/60 hover:border-black/12 hover:bg-[#ff544d] active:bg-[#bf403a] active:text-black/60 dark:border-none",
          isWindowFocused
      ...
      <button
        className={cn(
          "group flex h-3 w-3 cursor-default items-center justify-center rounded-full border text-center text-black/60 hover:border-black/12 hover:bg-[#ffbd2e] active:bg-[#bf9122] active:text-black/60 dark:border-none",
          isWindowFocused
      ...
      <button
        className={cn(
          "group flex h-3 w-3 cursor-default items-center justify-center rounded-full border text-center text-black/60 hover:border-black/12 hover:bg-[#28c93f] active:bg-[#1e9930] active:text-black/60 dark:border-none",
          isWindowFocused
